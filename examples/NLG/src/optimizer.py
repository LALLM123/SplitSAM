...
def create_optimizer_scheduler(optimizer, args):
    if args.scheduler == 'cosine':
        ...
        if args.i_steps is not None:
            if isinstance(args.i_steps, str):
                args.i_steps = [int(_i) for _i in args.i_steps.split(',')]
            elif isinstance(args.i_steps, list):
                args.i_steps = [int(_i) for _i in args.i_steps]
            
            if isinstance(args.i_lrs, str):
                args.i_lrs = [float(_i) for _i in args.i_lrs.split(',')]
            elif isinstance(args.i_lrs, list):
                args.i_lrs = [float(_i) for _i in args.i_lrs]
